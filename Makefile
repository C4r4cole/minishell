...
#    Updated: 2025/11/18 20:33:53 by fmoulin          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =	minishell.c parser/cleaner.c parser/expand.c parser/lexer.c parser/parser.c parser/syntax.c parser/tokens.c \
		...
		parser/tokens_helpers.c exec/exec_utils5.c exec/exec_utils6.c exec/exec_utils7.c exec/exec_redirections_cmds_utils.c exec/exec_cmd_list1.c \
